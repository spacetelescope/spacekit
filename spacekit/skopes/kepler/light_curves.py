...
import zipfile
# import spacekit
from spacekit.preprocessor.transform import hypersonic_pliers, thermo_fusion_chisel, babel_fish_dispenser
from spacekit.builder.networks import Builder
...
class Launch:
    def __init__(self, X_train, X_test, y_train, y_test):
        ...
        self.y_test = y_test
        self.builder = Builder(X_train, X_test, y_train, y_test)
        self.model = None
        self.history

    def deploy(self):
        self.model = self.builder.build_cnn()
        return self.model

    def takeoff(self):
        self.history = self.builder.fit(self.model)
