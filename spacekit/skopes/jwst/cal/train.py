...
class JwstCalTrain:
    ...
    def architecture(self):
        return dict(image="jwst_img3_reg", spec="jwst_spec3_reg")[self.exp_mode]
    ...
    def itr_metrics(self):
        ...
        """
        return OrderedDict(
            tr_size=0, ts_size=0, tr_lrg_ct=0, ts_lrg_ct=0, tr_lrg_mean=0, ts_lrg_mean=0, tr_lrg_max=0, ts_lrg_max=0
        )
    ...
    def record_metrics(self):
        ...
        dd = dict(train=self.jp.data.loc[self.jp.data.split == "train"], test=self.jp.data.loc[self.jp.data.split == "test"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-e", "--exp_mode", choices=["image", "spec"], default="image", help="image: train image model, spec: train spec model"
    )
    parser.add_argument(
        "-n",
        "--norm",
