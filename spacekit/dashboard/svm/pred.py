    ...
    children=[
                    ...
                    html.Div(children=[
                        html.Label([
                            ...
                            dcc.Dropdown(
                                id="image-state",
                                options=[
                                    {"label": "_".join(i.split("_")[-4:]), "value": i}
                                    for i in [
        ...
        html.Div(
            children=[
                ...
                html.P("Successful or Compromised? See if you can correctly identify which single visit mosaic images are aligned correctly and which ones are 'suspicious' or 'compromised' (likely to be misaligned). Can you beat the classifier algorithm?"),
                html.Div(children=[
                    html.Div(children=[
                        html.Label([
                            html.Label(
