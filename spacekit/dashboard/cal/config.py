...
global clf
clf = Builder(blueprint="memory_classifier", model_path=model_path+"/mem_clf").load_saved_model()

global mem_reg
#mem_reg = get_model("mem_reg", model_path=model_path)
mem_reg = Builder(blueprint="memory_regression", model_path=model_path+"/mem_reg").load_saved_model()

global wall_reg
#wall_reg = get_model("wall_reg", model_path=model_path)
wall_reg = Builder(blueprint="wallclock_regression", model_path=model_path+"/wall_reg").load_saved_model()
