...
class Radio:
    ...
    def mast_download(self):
        if self.obsid is None:
            ...
            search_params = dict(proposal_id=self.proposal_id, filters=self.filters, obsid=self.obsid)
        obs = Observations.query_criteria(**search_params)
        Observations.download_products(obs['obsid'], mrp_only=False, download_dir='./science',
