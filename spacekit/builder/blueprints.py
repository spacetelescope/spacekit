...
class Blueprint:
    def __init__(self, architecture):
        ...
        self.compile_params = {
            "ensemble_svm": dict(loss="binary_crossentropy", metrics=["accuracy"], optimizer=Adam(learning_rate=schedules.ExponentialDecay(initial_learning_rate=1e-4, decay_steps=100000, decay_rate=0.96, staircase=True)))
        }[architecture]
