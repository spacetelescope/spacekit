"""
This module scans local disk for model training results files generated by spacekit.analyzer.compute class objects. The MegaScanner class object is a convenient way to load results from multiple iterations of one or more models of any type, which can then be used to generate plots and perform comparitive model or data analysis on the fly. Primarily used by spacekit.dashboard but can easily be repurposed for other use-cases.
"""
import os
import pandas as pd
import glob
