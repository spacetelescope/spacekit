...
conf.read([os.path.join(os.path.dirname((os.path.dirname(__file__))), '..', 'setup.cfg')])
...
html_baseurl = "https://www.spacekit.org"
...
epub_copyright = '{0}, {1}'.format(datetime.datetime.now().year, author)
